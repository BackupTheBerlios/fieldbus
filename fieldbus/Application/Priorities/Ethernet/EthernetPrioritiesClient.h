...
#ifndef ETHERNETPRIORITIESCLIENT_H
#define ETHERNETPRIORITIESCLIENT_H
#include <omnetpp.h>
#include <fstream>
#include "Util.h"

/**
 * This is the simulation client for the Priorities case in Ethernet. Only node 1 or one
 ...
 */
class EthernetPrioritiesClient : public cSimpleModule
{
private:
	/**
...
public:
	 ...
	 */
	Module_Class_Members(EthernetPrioritiesClient, cSimpleModule, 0);
 ...
 * See OMNeT's user manual.</i>
 */
Define_Module(EthernetPrioritiesClient);
