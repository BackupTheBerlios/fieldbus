...
#include "ControlNetPrioritiesClient.h"

/**
 * This is only the implementation the PrioritiesClient class.
 */

void ControlNetPrioritiesClient::initialize()
{
	// DEBUG?
...
void ControlNetPrioritiesClient::handleMessage(cMessage* msg)
{
	...
	if (msg->isSelfMessage())
	{
		...
		{
			cMessage* reqMsg = new cMessage("UData", UNSCHEDULED);
	...
	else
	{
		...
		{
			ControlNetPrioritiesClient* client = check_and_cast<ControlNetPrioritiesClient*>
...
void ControlNetPrioritiesClient::record(simtime_t time)
{
...
void ControlNetPrioritiesClient::finish()
{
