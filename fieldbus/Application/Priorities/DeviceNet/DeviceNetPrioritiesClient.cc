...
#include "DeviceNetPrioritiesClient.h"

/**
 * This is only the implementation the PrioritiesClient class.
 */

void DeviceNetPrioritiesClient::initialize()
{
	// DEBUG?
...
void DeviceNetPrioritiesClient::handleMessage(cMessage* msg)
{
	...
	if (msg->isSelfMessage())
	{
		...
		{
			cMessage* reqMsg = new cMessage("Data", messageID + 10);
		...
		{
			cMessage* reqMsg = new cMessage("Data", messageID);
	...
	else
	{
		...
		{
			DeviceNetPrioritiesClient* client = check_and_cast<DeviceNetPrioritiesClient*>
...
void DeviceNetPrioritiesClient::record(simtime_t time)
{
...
void DeviceNetPrioritiesClient::finish()
{
