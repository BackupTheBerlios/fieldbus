...
#include "DeviceNetTenNodesClient.h"

/**
 * This is only the implementation the TenNodesClient class.
 */

void DeviceNetTenNodesClient::initialize()
{
	// DEBUG?
...
void DeviceNetTenNodesClient::handleMessage(cMessage* msg)
{
...
void DeviceNetTenNodesClient::finish()
{
