...
#ifndef CONTROLNETTENNODESCLIENT_H
#define CONTROLNETTENNODESCLIENT_H
#include <omnetpp.h>
#include "Util.h"

/**
 * This is the simulation client for the 10-Nodes case in ControlNet. His activity is only
 * controlled by the period range and the beginning time. All messages are put into the
 * scheduled area.
 */
class ControlNetTenNodesClient : public cSimpleModule
{
private:
	/**
...
public:
	 ...
	 */
	Module_Class_Members(ControlNetTenNodesClient, cSimpleModule, 0);
 ...
 * See OMNeT's user manual.</i>
 */
Define_Module(ControlNetTenNodesClient);
