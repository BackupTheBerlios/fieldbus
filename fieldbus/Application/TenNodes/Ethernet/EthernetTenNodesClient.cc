...
#include "EthernetTenNodesClient.h"

/**
 * This is only the implementation the TenNodesClient class.
 */

void EthernetTenNodesClient::initialize()
{
	// DEBUG?
...
void EthernetTenNodesClient::handleMessage(cMessage* msg)
{
	...
	if (msg->isSelfMessage())
	{
		...
		cMessage* reqMsg = new cMessage("Data", DATA);
...
void EthernetTenNodesClient::finish()
{
