...
/**
 * This is one implementation file of the ControlNetMACLogging class.
 */

// Some static member prototypes to suppress linking problems
simtime_t ControlNetMACLogging::totalMessageTimeDelay;
simtime_t ControlNetMACLogging::averageMessageTimeDelay;
simtime_t ControlNetMACLogging::transmittingTimeDelay;
simtime_t ControlNetMACLogging::retransmittingTimeDelay;
bool ControlNetMACLogging::messageTimeDelayFlag;

void ControlNetMACLogging::initialize()
{
...
void ControlNetMACLogging::handleMessage(cMessage* msg)
{
	Logging::handleMessage(msg);
}

void ControlNetMACLogging::finish()
{
}

void ControlNetMACLogging::writeStatistics(cStdDev* statistics)
{
...
void ControlNetMACLogging::write1Statistics(cStdDev* statistics)
{
	std::ofstream statisticsFile(par("fileName").stringValue(), std::ios_base::out | std::ios_base::app);
...
void ControlNetMACLogging::writeMessageTimeDelay()
{
	std::ofstream statisticsFile(par("fileName").stringValue(), std::ios_base::out | std::ios_base::app);
