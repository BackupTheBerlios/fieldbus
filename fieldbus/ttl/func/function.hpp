...
#ifndef __ttl_function__hpp
#define __ttl_function__hpp
...
#define TTL_MAX_FUNCTION_PARAMS 10
...
#define TTL_FUNC_BUILD_FUNCTION(n) \
	...
	template<  typename R, TTL_TPARAMS(TTL_MAX_FUNCTION_PARAMS) >
	struct function<R (TTL_ARGS(1)), T2, T3, T4, T5, T6, T7, T8, T9, T10 >
	{
		TTL_FUNC_BUILD_FUNCTION(1)
	};
	template<  typename R, TTL_TPARAMS(TTL_MAX_FUNCTION_PARAMS) >
	struct function<R (TTL_ARGS(2)), T3, T4, T5, T6, T7, T8, T9, T10 >
	{
		TTL_FUNC_BUILD_FUNCTION(2)
	};
	template<  typename R, TTL_TPARAMS(TTL_MAX_FUNCTION_PARAMS) >
	struct function<R (TTL_ARGS(3)), T4, T5, T6, T7, T8, T9, T10 >
	{
		TTL_FUNC_BUILD_FUNCTION(3)
	};
	template<  typename R, TTL_TPARAMS(TTL_MAX_FUNCTION_PARAMS) >
	struct function<R (TTL_ARGS(4)), T5, T6, T7, T8, T9, T10 >
	{
		TTL_FUNC_BUILD_FUNCTION(4)
	};
	template<  typename R, TTL_TPARAMS(TTL_MAX_FUNCTION_PARAMS) >
	struct function<R (TTL_ARGS(5)), T6, T7, T8, T9, T10 >
	{
		TTL_FUNC_BUILD_FUNCTION(5)
	};
	template<  typename R, TTL_TPARAMS(TTL_MAX_FUNCTION_PARAMS) >
	struct function<R (TTL_ARGS(6)), T7, T8, T9, T10 >
	{
		TTL_FUNC_BUILD_FUNCTION(6)
	};
	template<  typename R, TTL_TPARAMS(TTL_MAX_FUNCTION_PARAMS) >
	struct function<R (TTL_ARGS(7)), T8, T9, T10 >
	{
		TTL_FUNC_BUILD_FUNCTION(7)
	};
	template<  typename R, TTL_TPARAMS(TTL_MAX_FUNCTION_PARAMS) >
	struct function<R (TTL_ARGS(8)), T9, T10 >
	{
		TTL_FUNC_BUILD_FUNCTION(8)
	};
	template<  typename R, TTL_TPARAMS(TTL_MAX_FUNCTION_PARAMS) >
	struct function<R (TTL_ARGS(9)), T10 >
	{
		TTL_FUNC_BUILD_FUNCTION(9)
	};
	template<  typename R, TTL_TPARAMS(TTL_MAX_FUNCTION_PARAMS) >
	struct function<R (TTL_ARGS(10)) >
	{
